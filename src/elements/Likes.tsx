...
const Likes: React.FC<Props> = ({ photo, isAuth }) => {
  const dispatch = useDispatch();
  const [likesCounter, setLikesCounter] = useState(photo.likes);
  const [isLiked, setLiked] = useState(photo.liked_by_user);
