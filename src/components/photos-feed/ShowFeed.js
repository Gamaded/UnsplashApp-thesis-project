		...
		<ol className="photos-feed-container">
			<Link to='/fullscreen'>
				<li className="photos-feed-item">
					<img className="photos-feed-item__photo" src='' alt=""/>
					<div className="photos-feed-item__props">
						<div className="author">
							<img className="author__avatar" src='' alt=""/>
							<div className="author__name"><a href=''>Jopa</a></div>
						</div>
						<div className="date-likes-container">
							...
							<div className="likes">
								...
								<div className="likes-counter">123</div>
							</div>
						</div>
					</div>
				</li>
